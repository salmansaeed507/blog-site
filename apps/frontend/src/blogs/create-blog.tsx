...
export function CreateBlog() {
    ...
    const [mutationFunc, {loading, called}] = useMutation(CREATE_BLOG_MUTATION, {
        ...
        <form onSubmit={(e) => formHandler(e)}>
            <Row>
                ...
                <Col className="col-md-6">
                    <p>Title</p>
                    <p><input autoFocus type="text" className="form-control" value={title} onChange={(e) => setTitle(e.target.value) }/></p>
